...
if __name__ == '__main__':
    ...
    log = NewLogger(
        config={
            ...
            'project': "1434",
            # 实验描述和说明信息
            "description": "pnet_train_test",
            # 自定义实验名称
            "experiment_name": "pnet_train_test",
            # 仓库 ID
    ...
    for epoch in range(1, config.nEpochs + 1):
        ...
        cls_loss_, box_offset_loss, total_loss, accuracy = trainer.train(epoch, log)
        model_path = checkpoint.save_model(model, index=epoch)
